...
const { email, name, phone, address, age ,bloodgroup, gender, problem, symptoms  } = req.body
const role = 'patient'
...
user.username = user.email
const regUser = await User.register(user)
const patient = new AddPatient({ email, name, phone, address, age ,bloodgroup, gender, problem, symptoms })
